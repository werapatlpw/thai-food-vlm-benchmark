...
# ===== CONFIG =====
# Set the path to your GCP service account JSON key, and your project ID,
...
IMAGE_ROOT   = "./images"
OUTPUT_FILE  = "./benchmark_results/benchmark_results_gemini.xlsx"
RESUME_FILE  = "./benchmark_results/benchmark_progress_gemini.json"
DELAY_SEC    = 3
MAX_IMAGES   = 20
# ==================
    ...
    for i, (cat, menu_no, img_no, path) in enumerate(images, 1):
        ...
        for attempt in range(3):
            try:
                ...
                err = str(e)
                if ("429" in err or "quota" in err.lower() or "resource exhausted" in err.lower()) and attempt < 2:
                    wait = 60 * (attempt + 1)
