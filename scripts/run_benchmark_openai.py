...
MODEL        = "gpt-4o"
IMAGE_ROOT   = "./images"
OUTPUT_FILE  = "./benchmark_results/benchmark_results_openai.xlsx"
RESUME_FILE  = "./benchmark_results/benchmark_progress_openai.json"
DELAY_SEC    = 2
MAX_IMAGES   = 110
# ==================
...
def save_results(results):
    ...
    hfill = PatternFill("solid", fgColor="10A37F")  # สีเขียว OpenAI
